  ...
  <header :class="{headerColor:this.$store.state.headerColor,headerShow:this.$store.state.headerShow}">
    <div class="header">
      <div class="header_left">
        <div class="logo_wrap">
          <img src="http://xingqitv.cn/public/new/image/header/logo.png"
               alt />
        </div>
          ...
          <ul>
            <li class="downLoad">
              ...
              <div class="header_down">
                <img src="@/static/images/code2.png"
                     alt />
            ...
            <li class="hd_login">
              <div class="portrait_box">
                <img class="no-login"
                     src="@/static/images/top_sign_def.png"
                     alt />
              </div>
              <div class="login_btns">
                <div class="hd-login-bg">
                  <div class="hd-loginImg">
                    <img src="@/static/images/pic_hd.png"
                         alt />
                  </div>
                  <div>
                    <p>登录享高清观看体验</p>
    ...
    .header_left {
      ...
      .el-menu.el-menu--horizontal {
        ...
        .el-menu-item {
          ...
          &:hover {
            border: none;
            background-color: rgba(255, 185, 59, 1);
            color: #ffffff;
            /** border-radius: 16px;
            padding: 0 16px; **/
          }
      ...
      .header_operation {
        ...
        ul {
          ...
          li {
            ...
            &:hover {
              i {
                background-image: url('../../static/images/header-hover.png');
              }
              .nav_text {
                color: rgba(255, 185, 59, 1);
              }
            }
            i {
              display: block;
